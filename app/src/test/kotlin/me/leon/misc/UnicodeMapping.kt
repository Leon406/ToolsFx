...
fun String.unicodeChar() = toByteArray(Charsets.UTF_32BE)
    .asIterable().chunked(4).map { it.toByteArray().toString(Charsets.UTF_32BE) }

val mapping = FONTS.map {
    it.key to FONTS["normal"]!!.toCharArray().map { it.toString() }
