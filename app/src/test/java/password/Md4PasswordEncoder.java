 ...
 *
 * <p>Encodes passwords using MD4. The general format of the password is:
 *
 * <pre>
 * s = salt == null ? "" : "{" + salt + "}"
 * s + md4(password + s)
 * </pre>
 *
 * Such that "salt" is the salt, md4 is the digest method, and password is the actual password. For
 * example with a password of "password", and a salt of "thisissalt":
 *
 * <pre>
 ...
 * </pre>
 *
 * The format is intended to work with the Md4PasswordEncoder that was found in the Spring Security
 * core module. However, the passwords will need to be migrated to include any salt with the
 * password since this API provides Salt internally vs making it the responsibility of the user. To
 * migrate passwords from the SaltSource use the following:
 *
 * <pre>
