...
public class CRC64 implements Checksum {
    ...
    //    private final static long POLY =  0xD800000000000000L; // ISO
    ...
    private static void gf2MatrixSquare(long[] square, long[] mat) {
        for (int n = 0; n < GF2_DIM; n++) square[n] = gf2MatrixTimes(mat, mat[n]);
    }
    ...
    public static CRC64 combine(CRC64 summ1, CRC64 summ2, long len2) {
        // degenerate case.
        if (len2 == 0) return new CRC64(summ1.getValue());
        ...
        do {
            ...
            gf2MatrixSquare(even, odd);
            if ((len2 & 1) == 1) crc1 = gf2MatrixTimes(even, crc1);
            len2 >>>= 1;
            ...
            gf2MatrixSquare(odd, even);
            if ((len2 & 1) == 1) crc1 = gf2MatrixTimes(odd, crc1);
            len2 >>>= 1;
