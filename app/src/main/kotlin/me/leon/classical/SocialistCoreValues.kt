...
fun String.socialistCoreValues() = toHex().uppercase().map {
        ...
        when (this) {
            in 0..9 -> {
                ...
                if (Random.nextBoolean())
                    SOCIALISM[2 * 10] + SOCIALISM[2 * 10 + 1].toString() + SOCIALISM[2 * (this - 10)] + SOCIALISM[2 * (this - 10) + 1].toString()
                else SOCIALISM[2 * 11] + SOCIALISM[2 * 11 + 1].toString() + SOCIALISM[2 * (this - 6)] + SOCIALISM[2 * (this - 6) + 1].toString()
            }
        }
    }
